...
3 - exit";
            ...
            while (option != 3)
            {
                ...
                catch (Exception e)
                {
                    ...
                    Console.Error.WriteLine("Exception message: " + e.Message+ e.StackTrace);
                }
            }
        }
        ...
        private static void LearnFromNewExample()
        {
            ...
            topProgram = learned.RealizedPrograms.First();
            Console.Out.WriteLine("Top 4 learned programs:");
            var counter = 1;
            foreach (var program in learned.RealizedPrograms)
            {
                if (counter > 4) break;
